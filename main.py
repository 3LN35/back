...
from db.products_db import ProductInDB, get_all_products, get_single_product, create_product, change_product, delete_product
...
origins = [
    ...
    "http://localhost", "http://localhost:8080","https://sixginfo-front.herokuapp.com"
]
...
@api.post("/productos/delete/{product_id}")
